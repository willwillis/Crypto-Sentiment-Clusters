...
#             "in_reply_to_status_id_str" : data["in_reply_to_status_id_str"]
            ...
            if 'user' in data:
                captured_fields['user_favourites_count'] = data['user']['favourites_count']
                captured_fields['user_followers_count'] = data['user']['followers_count']
                captured_fields['user_friends_count'] = data['user']['friends_count']
                captured_fields['user_location'] = data['user']['location']
                captured_fields['user_profile_image_url'] = data['user']['profile_image_url']
                captured_fields['user_id'] = data['user']['id']
                
            if 'quoted_status' in data:
                captured_fields['quoted_quote_count'] = data['quoted_status']['quote_count']
                captured_fields['quoted_reply_count'] = data['quoted_status']['reply_count']
                captured_fields['quoted_retweet_count'] = data['quoted_status']['retweet_count']
